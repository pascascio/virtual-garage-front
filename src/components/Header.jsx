...
export default function Header({onLoginClick, onSignUpClick, isLoggedIn, onLogout}){
    return(
        <header className = "p-4 bg-stone-800">
        <nav className = "flex items-center justify-between">
            <div className = "flex items-center space-x-3">
            {/* <img src = "logo.png" alt = "Virtual Garage Logo" className = "h-8 w-auto"/>*/}
            <h1 className = " text-2xl font-light text-stone-200">Virtual Garage</h1>
            </div>
            {isLoggedIn? 
            <ul className = "flex space-x-4">
                 <li className = "hover:text-stone-300"> Home</li> 
                <li className = "hover:text-stone-300" onClick = {onLogout}>  Logout</li> 
                </ul>
                :
            <ul className = "flex space-x-4">
